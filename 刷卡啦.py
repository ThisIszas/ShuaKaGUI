...
class BasePanel(wx.Panel):
    def __init__(self, parent):
        ...
        self.quote = wx.StaticText(self, label=" Hi, it's really nice that you can use this small program. ",
                                   pos=(0, 20))
        self.logger = wx.TextCtrl(self, pos=(5, 200), size=(370, 240), style=wx.MULTIPLE | wx.TE_READONLY)

        self.confirm_button = wx.Button(self, label="Confirm", pos=(160, 88))
...
app = wx.App(False)
frame = MyFrame(None, u'好好学习,天天刷卡')
